...
def copyreobfuscatedfiles(soulforge_dir, mcp_dir):
    basediff = os.path.join(soulforge_dir, 'soulforgedev', 'basediff')
...
def movetodist(soulforge_dir):
    ...
    distdir = os.path.join(soulforge_dir, 'soulforgedev', 'tempdist')
    ...
    if os.path.isfile(os.path.join(soulforge_dir, 'soulforgedev', 'tempdist', '.gitignore')):
        os.remove(os.path.join(soulforge_dir, 'soulforgedev', 'tempdist', '.gitignore'))
        
    if os.path.exists(os.path.join(distdir, 'java')):
        shutil.rmtree(os.path.join(distdir, 'java'))
    
def packagedist(soulforge_dir):
    if os.path.exists(os.path.join(soulforge_dir, 'soulforgedev', 'dist')):
        shutil.rmtree(os.path.join(soulforge_dir, 'soulforgedev', 'dist'))
    os.makedirs(os.path.join(soulforge_dir, 'soulforgedev','dist'))
    
    zipdir(os.path.join(soulforge_dir, 'soulforgedev', 'tempdist'), os.path.join(soulforge_dir, 'soulforgedev', 'dist', 'Soulforge-Patcher-Universal.zip'))

    if os.path.exists(os.path.join(soulforge_dir, 'soulforgedev', 'tempdist')):
        shutil.rmtree(os.path.join(soulforge_dir, 'soulforgedev', 'tempdist'))
#==========================================================================
#                     Cleanup
#==========================================================================
def cleanup(soulforge_dir, mcp_dir):
    ...
    if os.path.exists(soulforge_mcp_csrc_loc):
        shutil.rmtree(soulforge_mcp_csrc_loc)
    if os.path.exists(soulforge_mcp_ssrc_loc):
        shutil.rmtree(soulforge_mcp_ssrc_loc)

    if os.path.exists(biome_mcp_csrc_loc):
        shutil.rmtree(biome_mcp_csrc_loc)
    if os.path.exists(biome_mcp_ssrc_loc):
        shutil.rmtree(biome_mcp_ssrc_loc)

    if os.path.exists(ore_mcp_csrc_loc):
        shutil.rmtree(ore_mcp_csrc_loc)
    if os.path.exists(ore_mcp_ssrc_loc):
        shutil.rmtree(ore_mcp_ssrc_loc)
