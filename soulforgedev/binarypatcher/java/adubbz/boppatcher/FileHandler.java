...
public class FileHandler 
{
	...
	public static void copyModNonBTWEdits(File jarloc)
	{
		...
		{
			File mcJar = new File(subdir.getAbsoluteFile() + File.separator + "nonbtwedits" + File.separator + "MINECRAFT-JAR");
			File mcServerJar = new File(subdir.getAbsoluteFile() + File.separator + "nonbtwedits" + File.separator + "MINECRAFT_SERVER-JAR");
