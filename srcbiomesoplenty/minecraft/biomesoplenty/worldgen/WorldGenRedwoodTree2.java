				...
				if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
				{
					...
					for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
					{
						...
						for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
						{
							...
							for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
							{
								...
								{
									this.setBlockAndMetadata(par1World, var14, var11 + 12, var16, leavesID, leavesMeta);
					...
					for (var11 = 0; var11 < var6; ++var11)
					{
						...
						if (var12 == 0 || var12 == leavesID)
						{
							...
							//2
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 2), par5, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 2), par5, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 2), par5 - 1, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 2), par5 + 1, logID, metaWood);

							//3
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 4), par5 - 1, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 4), par5 - 1, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 4), par5 + 1, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 4), par5 + 1, logID, metaWood);

							//4
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 8), par5, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 8), par5, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 8), par5 - 2, logID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 8), par5 + 2, logID, metaWood);
