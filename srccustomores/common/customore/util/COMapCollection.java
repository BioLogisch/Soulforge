...
public abstract class COMapCollection<K,V> implements Collection<V>
{
    protected final Map<K,V> backingMap;

    public COMapCollection(Map<K,V> backingMap)
    {
    ...
    {
        return obj instanceof COMapCollection ? this.backingMap.equals(((COMapCollection)obj).backingMap) : false;
    }
