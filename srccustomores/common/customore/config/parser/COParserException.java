...
public class COParserException extends SAXException
{
    public final Node node;
    public int lineNumber;

    public COParserException(String message, Node node, int lineNumber, Exception parent)
    {
    ...
    public COParserException(String message, Node node, int lineNumber)
    {
        super(message);
        this.node = node;
        this.lineNumber = lineNumber;
    ...
    public COParserException(String message, Node node, Exception parent)
    {
        this(message, node, -1, parent);
    }

    public COParserException(String message, Node node)
    {
        this(message, node, -1);
    }

    public COParserException(String message, int lineNumber, Exception parent)
    {
        this(message, (Node)null, lineNumber, parent);
    }

    public COParserException(String message, int lineNumber)
    {
        this(message, (Node)null, lineNumber);
    }

    public COParserException(String message, Exception parent)
    {
        this(message, (Node)null, -1, parent);
    }

    public COParserException(String message)
    {
        this(message, (Node)null, -1);
    }

    public COParserException(Exception parent)
    {
        super(parent);
        this.node = null;
        this.lineNumber = -1;
