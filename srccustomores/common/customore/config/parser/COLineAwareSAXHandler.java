...
public class COLineAwareSAXHandler extends DefaultHandler
{
    private Locator locator = null;
    private final Stack nodeStack = new Stack();

    public COLineAwareSAXHandler(Node root)
    {
    ...
    public void fatalError(SAXParseException ex) throws COParserException
    {
        throw new COParserException(ex.getMessage(), (Node)this.nodeStack.peek(), this.locator.getLineNumber(), ex);
    }
}
