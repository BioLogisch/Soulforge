...
public class COChoiceOption extends COConfigOption
{
    private String _value = null;
    private COCIStringMap<String[]> _valueMap = new COCIStringMap(new LinkedHashMap());

    public COChoiceOption(String name)
    {
        super(name);
    }
