...
public class COSpawnableChunkLoaderBlock extends Block implements ITileEntityProvider {

	private Icon texture;
	private Icon textureActivated;

	public COSpawnableChunkLoaderBlock(int par1, Material par2Material) {
	...
	public TileEntity createNewTileEntity(World world) {
		return new COChunkLoaderTileEntity(true);
	}
	...
	{
		texture = iconRegister.registerIcon("customore:chunkloaderspawn");
		textureActivated = iconRegister.registerIcon("customore:chunkloaderspawnactive");
	}
