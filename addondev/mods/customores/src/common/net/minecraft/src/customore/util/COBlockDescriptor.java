...
public class COBlockDescriptor implements Copyable<COBlockDescriptor>
{
    ...
    public COBlockDescriptor()
    {
        this.clear();
    }

    public COBlockDescriptor(String descriptor)
    {
        this.set(descriptor);
    }

    public void copyFrom(COBlockDescriptor source)
    {
    ...
    public COBlockDescriptor set(String descriptor)
    {
        this.clear();
    ...
    public COBlockDescriptor add(String descriptor)
    {
        return this.add(descriptor, 1.0F);
    }

    public COBlockDescriptor add(String descriptor, float weight)
    {
    ...
    public COBlockDescriptor clear()
    {
        this._compiled = false;
