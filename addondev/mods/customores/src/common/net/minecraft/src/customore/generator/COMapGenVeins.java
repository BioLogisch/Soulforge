...
import net.minecraft.src.customore.generator.tools.CODistributionSettingMap;
import net.minecraft.src.customore.generator.tools.COPDist;
import net.minecraft.src.customore.generator.tools.COTransform;
import net.minecraft.src.customore.generator.tools.CODistributionSettingMap.DistributionSetting;
import net.minecraft.src.customore.generator.tools.COPDist.Type;
import net.minecraft.src.customore.util.COLogger;



public class COMapGenVeins extends COMapGenOreDistribution
{
    @DistributionSetting(
            name = "branchType",
    ...
    protected static final CODistributionSettingMap _veinsSettingMap = new CODistributionSettingMap(COMapGenVeins.class);

    public COMapGenVeins(int distributionID, boolean canGenerate)
    {
        ...
        this.mlSize = new COPDist(2.5F, 1.0F);
        this.mlHeight = new COPDist(32.0F, 16.0F, Type.normal);
        this.brFrequency = new COPDist(3.0F, 2.0F);
        this.brInclination = new COPDist(0.0F, 0.55F);
        this.brLength = new COPDist(120.0F, 60.0F);
        this.brHeightLimit = new COPDist(16.0F, 0.0F);
        this.sgForkFrequency = new COPDist(0.2F, 0.0F);
        this.sgForkLenMult = new COPDist(0.75F, 0.25F);
        this.sgLength = new COPDist(15.0F, 6.0F);
        this.sgAngle = new COPDist(0.5F, 0.5F);
        this.sgRadius = new COPDist(0.5F, 0.3F);
        this.orDensity = new COPDist(1.0F, 0.0F);
    ...
    public Component generateStructure(StructureGroup structureGroup, Random random)
    {
        ...
        {
            COTransform mlMat = new COTransform();
            ...
            for (int br = this.brFrequency.getIntValue(random); br > 0; --br)
            {
                ...
                COTransform segMat = new COTransform();
    ...
    public void generateBranch(StructureGroup structureGroup, float length, float maxHeight, float minHeight, COTransform mat, Component parent, Random random)
    {
        ...
        while (length > 0.0F)
        {
            ...
            COTransform segMat = mat.clone().scale(segRad, segRad, segLen);
    ...
    private class BezierTubeComponent extends Component
    {
        ...
        public BezierTubeComponent(StructureGroup structureGroup, COTransform transform)
        {
    ...
    class SolidSphereComponent extends Component
    {
        ...
        public SolidSphereComponent(StructureGroup structureGroup, COTransform transform)
        {
            super(structureGroup);
