...
public class CODistributionSettingMap
{
    private final Map<String,Object[]> _settingMap = new COCIStringMap(new LinkedHashMap());

    public CODistributionSettingMap(Class distributionType)
    {
    ...
    {
        COCIStringMap<String> descriptions = new COCIStringMap(new LinkedHashMap());
    ...
    public Object get(ICOOreDistribution dist, String settingName)
    {
        if (dist == null)
        {
            return null;
    ...
    public void set(ICOOreDistribution dist, String settingName, Object value) throws IllegalArgumentException, IllegalAccessException
    {
        if (dist != null)
        {
            ...
            else
            {
                ...
                {
                    value = COConfigParser.parseString(field.getType(), (String)value);
                }
    ...
    public void inheritAll(ICOOreDistribution source, ICOOreDistribution destination)
    {
