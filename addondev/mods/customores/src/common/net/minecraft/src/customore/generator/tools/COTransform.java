package net.minecraft.src.customore.generator.tools;

public class COTransform implements Cloneable
{
    private float[] mat;
    ...
    protected COTransform(float[] matrix)
    {
        this.mat = matrix;
    }

    public COTransform clone()
    {
        return new COTransform((float[])this.mat.clone());
    }
    ...
    public COTransform transform(COTransform trans)
    {
    ...
    public COTransform rotate(float angle, float axisX, float axisY, float axisZ)
    {
    ...
    public COTransform rotateX(float angle)
    {
        float s = (float)Math.sin((double)angle);
    ...
    public COTransform rotateY(float angle)
    {
        float s = (float)Math.sin((double)angle);
        float c = (float)Math.cos((double)angle);
        float tmp = 0.0F;
    ...
    public COTransform rotateZ(float angle)
    {
        float s = (float)Math.sin((double)angle);
        float c = (float)Math.cos((double)angle);
        float tmp = 0.0F;
    ...
    public COTransform rotateXInto(float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public COTransform rotateYInto(float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public COTransform rotateZInto(float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public COTransform scale(float scaleM, float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public COTransform scale(float scaleX, float scaleY, float scaleZ)
    {
        this.mat[0] *= scaleX;
        this.mat[1] *= scaleY;
        this.mat[2] *= scaleZ;
    ...
    public COTransform shear(float angle, float shearX, float shearY, float shearZ, float invariantX, float invariantY, float invariantZ)
    {
    ...
    public COTransform reflect(float mirrorNormalX, float mirrorNormalY, float mirrorNormalZ)
    {
    ...
    public COTransform translate(float transX, float transY, float transZ)
    {
