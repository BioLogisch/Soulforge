...
import net.minecraft.src.customore.generator.tools.CODistributionSettingMap.Copyable;


public class COBiomeDescriptor implements Copyable<COBiomeDescriptor>
{
    ...
    public COBiomeDescriptor()
    {
        this.clear();
    }

    public COBiomeDescriptor(String descriptor)
    {
        this.set(descriptor);
    }
    
    public void copyFrom(COBiomeDescriptor source)
    {
    ...
    public COBiomeDescriptor set(String descriptor)
    {
        this.clear();
    ...
    public COBiomeDescriptor add(String descriptor)
    {
        return this.add(descriptor, 1.0F);
    }

    public COBiomeDescriptor add(String descriptor, float weight)
    {
        return this.add(descriptor, 1.0F, new Climate(), false);
    }
    
    public COBiomeDescriptor add(String descriptor, float weight, Climate climate, boolean describesType)
    {
    ...
    public COBiomeDescriptor addAll(COBiomeDescriptor descriptor, float weight) {
    	this._compiled = false;
    	if (weight == 1.0F) {
    ...
    public COBiomeDescriptor clear()
    {
        this._compiled = false;
