...
public class WorldGenAcacia extends WorldGenerator
{
	...
	public boolean generate(World par1World, Random par2Random, int x, int y, int z)
	{
		...
		{
			logID = BOPAPIBlocks.logs1.blockID;
			logMeta = 2;
		}
		else
		{
		...
		for(int i = 0; i < rand; i++) { par1World.setBlock(x, y + i, z, logID, 0, 2); }

		if(par2Random.nextInt(4) == 0) { //branch1
			par1World.setBlock(x + 0, y + rand + 1, z + 1, logID, 0, logMeta);
			par1World.setBlock(x + 1, y + rand + 2, z + 2, logID, 0, logMeta);
		...
		if(par2Random.nextInt(4) == 0) { //branch2
			par1World.setBlock(x + 1, y + rand + 0, z + 0, logID, 0, logMeta);
			par1World.setBlock(x + 2, y + rand + 1, z + 0, logID, 0, logMeta);
			par1World.setBlock(x + 3, y + rand + 2, z - 1, logID, 0, logMeta);
		...
		if(par2Random.nextInt(4) == 0) { //branch3
			...
			par1World.setBlock(x - 2, y + rand + 1, z + 0, logID, 0, logMeta);
			par1World.setBlock(x - 3, y + rand + 2, z - 1, logID, 0, logMeta);
			par1World.setBlock(x - 4, y + rand + 3, z - 2, logID, 0, logMeta);
		...
		if(par2Random.nextInt(4) == 0) { //branch4
			par1World.setBlock(x + 0, y + rand + 0, z - 1, logID, 0, logMeta);
			par1World.setBlock(x + 1, y + rand + 1, z - 2, logID, 0, logMeta);
			par1World.setBlock(x + 2, y + rand + 2, z - 2, logID, 0, logMeta);
			par1World.setBlock(x + 3, y + rand + 3, z - 2, logID, 0, logMeta);
		...
		if(par2Random.nextInt(4) == 0) { //branch5
			par1World.setBlock(x + 0, y + rand + 0, z - 1, logID, 0, logMeta);
			par1World.setBlock(x + 0, y + rand + 0, z - 2, logID, 0, logMeta);
			par1World.setBlock(x + 1, y + rand + 1, z - 3, logID, 0, logMeta);
			createAcaciaLeaves(par1World, par2Random, x + 1, y + rand + 1, z - 3, 3);
			createAcaciaLeaves(par1World, par2Random, x + 1, y + rand + 2, z - 3, 2);
		}

		//branch6
		par1World.setBlock(x - 0, y + rand + 0, z + 0, logID, 0, logMeta);
		par1World.setBlock(x - 0, y + rand + 1, z + 0, logID, 0, logMeta);
		par1World.setBlock(x - 0, y + rand + 2, z - 0, logID, 0, logMeta);
		...
		for(int x1 = -size + x; x1 < size + 1 + x; x1++)
		{
			for(int z1 = -size + z; z1 < size + 1 + z; z1++)
			{
				...
				if (var5 == 0)
				{
					...
					else { par1World.setBlock(x1, y, z1, leavesID, 0, leavesMeta); }
				}
			}
		}
		if(size==3){par1World.setBlock(x, y, z, logID, 0, logMeta);}
	}
}
